...
import { selectDrawerAdminHidden } from "../redux/ui/ui.selectors";
import DrawerList from "./drawer-provider-items.container";
...
const DrawerCart = ({ hiddenAdmin, toggleDrawerAdminHidden }) => {
